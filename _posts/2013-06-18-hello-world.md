...
ps: We built this blog using [Github Pages](http://pages.github.com), which uses something called [jekyll](http://jekyllrb.com/). Take a peek at the [repository](https://github.com/carlad/inchworms/tree/gh-pages) if you like :-)
